...
*MealMate is a full-stack web application built using Python & Django that allows users to browse restaurants, view menus, and place orders. The system also provides an admin interface to manage restaurants, menu items, and customer data.*
